...
export default async function GuiaConsumidorPage() {
    ...
    <main className="relative min-h-screen py-16 px-4">
      ...
      <div className="z-10 max-w-3xl mx-auto">
        ...
        <div className="p-8 md:p-12 rounded-3xl bg-white/10 backdrop-blur-xl shadow-2xl border border-white/20">
          <h1 className="text-3xl font-bold text-white mb-2 tracking-wide">Guía del Consumidor</h1>
          <p className="text-white/40 text-xs mb-8">¿Cómo participar, visitar y votar?</p>
          ...
          {cfg.guiaConsumidor ? (
            ...
            <p className="text-white/40 text-sm italic">
              La guía del consumidor aún no ha sido publicada.
            </p>
          )}
        </div>
      </div>
