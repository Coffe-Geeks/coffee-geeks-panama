...
export default async function PoliticaComprasPage() {
    ...
    <main className="relative min-h-screen py-16 px-4">
      ...
      <div className="z-10 max-w-3xl mx-auto">
        ...
        <div className="p-8 md:p-12 rounded-3xl bg-white/10 backdrop-blur-xl shadow-2xl border border-white/20">
          <h1 className="text-3xl font-bold text-white mb-2 tracking-wide font-black">Política de Compras</h1>
          <p className="text-white/40 text-xs mb-8">Políticas de envío, devolución y compras de la tienda</p>
          ...
          {cfg.purchasePolicy ? (
            ...
            <p className="text-white/40 text-sm italic">
              La política de compras aún no ha sido publicada.
            </p>
          )}
        </div>
      </div>
