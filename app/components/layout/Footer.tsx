  ...
  return (
    <>
      <style>{`
        ...
        .fts:hover { border-color: #cddbf2; background: rgba(205,219,242,.1); color: #cddbf2; }
        .fts svg { width: 12px; height: 12px; stroke: currentColor; fill: none; strokeWidth: 1.5; }
        .ft-mid {
        ...
        <div className="ft-wrap">
          ...
          <div className="ft-top">
            ...
            <div className="ft-soc">
              {config.facebook && (
                <a href={enlaceExterno(config.facebook, "facebook")} target="_blank" rel="noopener noreferrer" className="fts" aria-label="Facebook">
              ...
              {config.instagram && (
                <a href={enlaceExterno(config.instagram, "instagram")} target="_blank" rel="noopener noreferrer" className="fts" aria-label="Instagram">
                  <svg viewBox="0 0 24 24">
              ...
              {config.twitter && (
                <a href={enlaceExterno(config.twitter, "twitter")} target="_blank" rel="noopener noreferrer" className="fts" aria-label="Twitter">
                  <svg viewBox="0 0 24 24">
              ...
              {config.youtube && (
                <a href={enlaceExterno(config.youtube, "youtube")} target="_blank" rel="noopener noreferrer" className="fts" aria-label="YouTube">
                  <svg viewBox="0 0 24 24">
