...
export default async function AdminUsersPage() {
  ...
  const users = rawUsers.map((u: any) => ({
    ...
    tagline: u.tagline || "",
    originStory: u.originStory || "",
    espresso: u.espresso || "",
    filtrado: u.filtrado || "",
    signatureDrinkName: u.signatureDrinkName || "",
    signatureDrink: u.signatureDrink || "",
    espressoPhoto: u.espressoPhoto || "",
    filtradoPhoto: u.filtradoPhoto || "",
    signatureDrinkPhoto: u.signatureDrinkPhoto || "",
    advancedToRound2: !!u.advancedToRound2,
